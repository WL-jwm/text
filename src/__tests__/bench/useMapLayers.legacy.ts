...
import { CATEGORY_COLORS, createCircleIcon, createPulseIcon, createGradeBubble, createWaterSourceIcon, createKarstSpringIcon, WATER_SOURCE_COORDS, KARST_SPRING_COORDS } from '../../pages/mapConstants';
import {
