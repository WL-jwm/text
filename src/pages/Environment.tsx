...
import { TrendingDown, AlertTriangle, ArrowDown, Shield, Activity, Droplets, CheckCircle2, ShieldAlert, CloudRain, FlaskConical } from 'lucide-react';
...
import { ClimateImpactTab } from '../components/environment/ClimateImpactTab';
import { RemediationTab } from '../components/environment/RemediationTab';
...
const TABS = [
  ...
  { key: 'climate', label: '气候变化', icon: CloudRain },
  { key: 'remediation', label: '修复评估', icon: FlaskConical },
] as const;
...
export function Environment() {
  ...
  return (
    <div className="p-3 md:p-6 max-w-[1440px] mx-auto space-y-6">
      ...
      {activeTab === 'climate' && <ClimateImpactTab />}
