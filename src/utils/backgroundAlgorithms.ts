/**
 * 地下水背景值计算 — 核心算法
 *  背景值(均值±2σ/格鲁布斯/迭代2σ) / 分区对比 / 超标统计 / 趋势检测
 */

import type { BackgroundValueInput, BackgroundValueResult, ZoneCompareResult, ExceedanceResult, TrendDetectionResult } from './backgroundTypes';
import { mean, std, round, grubbsCritical, median } from './backgroundUtils';
