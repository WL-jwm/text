/**
 * 时间序列分析 — 核心算法
 *  趋势(线性回归+MK检验+Sen斜率) / 周期性 / Pettitt变点 / 预测(3模型) / 自相关 / 综合分析
 */

import type { TimeSeriesInput, TrendResult, PeriodicityResult, ChangePointResult, ForecastResult, AutoCorrelationResult, TimeSeriesResult } from './timeSeriesTypes';
import { mean, std, round, normalCDF } from './timeSeriesUtils';
